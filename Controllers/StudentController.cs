...
namespace CRUDWITHEF.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,NAME,EMAIL,DEPARTMENT")] Table_1 table_1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NAME,EMAIL,DEPARTMENT")] Table_1 table_1)
        {
            if (ModelState.IsValid)
            {
